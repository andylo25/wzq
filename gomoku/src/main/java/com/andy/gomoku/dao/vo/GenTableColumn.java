...
public class GenTableColumn implements Serializable {
	...
	public String getCodeType() {
		if(StringUtils.isNotBlank(comments)){
			return StringUtils.substringAfter(comments, ":");
		}
		return null;
	}
	...
	public String getComments() {
		if(StringUtils.isNotBlank(comments)){
			return StringUtils.substringBefore(comments, ":");
		}
		return comments;
	}
	...
	public void setComments(String comments) {
		if(StringUtils.isNotBlank(comments)){
			comments = StringUtils.substringBefore(comments,"(");
		}
	...
	public Boolean getIsNotBaseField(){
		return !StringUtils.equals(getSimpleJavaField(), "id")
				...
				&& !StringUtils.equals(getSimpleJavaField(), "createUid")
				&& !StringUtils.equals(getSimpleJavaField(), "updateUid")
	 ...
	 * @return
	 */
	public Boolean getIsNotListField(){
		return !StringUtils.equals(getSimpleJavaField(), "id")
				&& !StringUtils.equals(getSimpleJavaField(), "createUid")
				&& !StringUtils.equals(getSimpleJavaField(), "updateUid")
				&& !StringUtils.equals(getSimpleJavaField(), "updateTime")
